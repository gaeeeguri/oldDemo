  ...
  return (
    <>
      <footer className='flex content-center justify-center bottom-0 sticky bg-primary h-16 items-center'>
        <nav className='container h-full flex content-center items-center justify-between px-8 font-semibold leading-6 bottom-0 border-t-2 border-b-blue-300 max-w-md'>
          <NavLink
            href={'/search'}
