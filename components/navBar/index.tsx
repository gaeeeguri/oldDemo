  ...
  return (
    <>
      <footer className='flex content-center justify-center bottom-0 sticky bg-primary h-16 items-center'>
        <nav className='container flex content-center items-center justify-between px-12 py-4 mx-auto font-semibold leading-6 lg:py-6 bottom-0 border-t-2 border-b-blue-300 max-w-md'>
          <NavLink
            href={'/search'}
